...
def ask_llm(question, context):
    prompt = f"""
You are an intelligent document question answering assistant created for NavaVeda .
...
st.set_page_config(
    page_title="NavaVeda  | Intelligent Document QA System",
    page_icon="📘",
    layout="wide"
)
...
st.markdown(
    '<div class="main-title">NavaVeda</div>',
    unsafe_allow_html=True
)
...
<b>Author:</b> Raviraj Shankar Aade<br><br>
...
Project developed by Raviraj Shankar Aade | Date: 13/05/2026
</div>
""", unsafe_allow_html=True)